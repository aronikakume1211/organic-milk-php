                ...
                ?>
                        <div class="row mt-4">
                            ...
                            <div class="col-7 col-md-7">
                                <?php echo $row[2]; ?>
                                <div class="row">
                                    <div class="col-12 col-md-12"><?php echo $row[6]; ?></div>
                                </div>
                                <div class="row mt-4">
                                    ...
                                    <div class="col-1 col-md-1">
                                        <span class="del" style="cursor: pointer;" onclick="deleteElement(<?php echo $key; ?>)" data-product-id="<?php echo $key; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        jQuery('.btn-close').click(function() {
            if($('#cart_counter').text() < 0) {
                console.log('low Have valie');
                $('#cpops-floating-cart').hide();
            }
            closeModal();
        });
